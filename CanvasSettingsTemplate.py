# Credits to this file goes to professor Bill Siever, with my own modifications
...
##### SEMESTER
# Choose the semester of the course by commenting out the others
# SEMESTER = 'su19'
# SEMESTER = 'fl21'
SEMESTER = 'sp24'
...
###### Canvas Survey Name
# This should match the naming pattern of the surveys
SURVEY_NAME = "Weekly Survey"
